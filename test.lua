...
assertq( fn.insert({1,2,3,4,5},{6,7},1), {6,7,1,2,3,4,5} )
assertq( fn.insert({1,2,3,4,5},{6,7},2), {1,6,7,2,3,4,5} )
assertq( fn.insert({1,2,3,4,5},{6,7},-2),{1,2,3,4,6,7,5} )
assertq( fn.insert({1,2,3,4,5},{6,7},-1000),{6,7,1,2,3,4,5})
assertq( fn.insert({1,2,3,4,5},{6,7},1000),{1,2,3,4,5,6,7})
