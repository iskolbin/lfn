...
assertq( fn.pairs{x = 2, y = 3, z = 4}:sort(fn'@1[1] < @2[1]'), {{'x',2},{'y',3},{'z',4}})
...
assertq( fn{1,2,3,4}:zip(), {1,2,3,4} )
assertq( fn{}:zip(), {} )
assertq( fn.zip( {1,2}, {'x','y'}, {55.55,66.66} ), {{1,'x',55.55},{2,'y',66.66}} )
assertq( fn.zip( {1,2}, {'x','y','z'}, {55.55} ), {{1,'x',55.55},{2,'y',nil}})
assertq( fn{{1,'x',55.55},{2,'y',66.66}}:unzip(), {{1,2},{'x','y'},{55.55,66.66}} )
assertq( fn.zip( {'x','y','z'}, {1,2,3}):frompairs(), {x = 1, y = 2, z = 3} )
assertq( fn.frequencies{ 'x', 'y', 'z', 'x', 'y', 'x' }, {x = 3, y = 2, z = 1} )
assert( getmetatable( fn.plain( setmetatable( {}, {} ))) == nil )
assert( getmetatable( fn{1,2,3}:plain()) == nil )
assert( fn([[@ - 2]], 2)() == 0 )
assert( fn([[@1 + @2 + @3]], 1, 2 )( 3 ) == 6 )
assertq( fn{1,2,3,4}:insert(), {1,2,3,4} )
...
assertq( fn{x = 5, y = 6, z = 8}:difference(), {x = 5, y = 6, z = 8} )
assertq( fn{x = 5, y = 6, z = 8}:difference{}, {x = 5, y = 6, z = 8} )
assertq( fn{x = 5, y = 6, z = 8}:difference({x = 6},{}), {y = 6, z = 8} )
assertq( fn{x = 5, y = 6, z = 8}:difference{x = 6}, {y = 6, z = 8} )
assertq( fn{x = 5, y = 6, z = 8}:difference({x = 6, k = 8}, {y = 11, a = 18}, {c = 3,x=4}), {z = 8} )
assertq( fn{x = 5, y = 6, z = 8}:intersection{x = 1}, {x = 5} )
assertq( fn{x = 5, y = 6, z = 8}:intersection(), {} )
assertq( fn{x = 5, y = 6, z = 8}:intersection{}, {} )
assertq( fn{x = 5, y = 6, z = 8}:intersection({x = 1}, {y = 2}), {} )
assertq( fn{x = 5, y = 6, z = 8}:intersection({x = 1,y = 2}, {y = 4}), {y = 6} )
assertq( fn{x = 5, y = 6, z = 8}:intersection({x = 1,y = 2}, {y = 4}, {}), {} )
assertq( fn{x = 5, y = 6, z = 8}:union(), {x = 5, y = 6, z = 8} )
assertq( fn{x = 5, y = 6, z = 8}:union{}, {x = 5, y = 6, z = 8} )
assertq( fn{x = 5, y = 6, z = 8}:union{x = 11}, {x = 5, y = 6, z = 8} )
assertq( fn{x = 5, y = 6, z = 8}:union({x = 11},{y = 22}), {x = 5, y = 6, z = 8} )
assertq( fn{x = 5, y = 6, z = 8}:union({x = 11},{y = 22, b = 14}), {b = 14, x = 5, y = 6, z = 8} )
assertq( fn{x = 5}:diff{x = 5}, {} )
assertq( fn{x = 5}:diff{x = 6}, {x = 6} )
assertq( fn{x = 5}:diff{x = 5, y = 5},{y = 5})
assertq( fn{x = 5}:diff{x = 6, y = 5},{x = 6, y = 5})
assertq( fn{x = 5}:diff{y = 5}, {x = fn.NIL, y = 5} )
assertq( fn{x = 5}:diff{y = {z = 6}}, {x = fn.NIL, y = {z = 6}})
assertq( fn{x = 5}:diff{x = {z = 6}}, {x = {z = 6}} )
assertq( fn.diff( 5, 6 ), 6 )
assertq( fn.diff( {}, 'str' ), 'str' )
assertq( fn.diff( 'asd', {} ), {} )
assertq( fn{x = {y = 6}}:diff{x = {y = 6}}, {} )
assertq( fn{x = {y = 6}}:diff{x = {y = 7}}, {x = {y = 7}} )
assertq( fn{x = {y = 6}}:diff{x = {z = 7}}, {x = {y = fn.NIL,z = 7}} )
assertq( fn{x = {y = 6}}:diff{x = 5}, {x = 5})
assertq( fn{x = 5}:patch{x = 5}, {x = 5} )
assertq( fn{x = 5}:patch{x = 6}, {x = 6} )
assertq( fn{x = {y = 6}}:patch{x = 6}, {x = 6} )
assertq( fn{x = {y = 6}, z = 55}:patch{x = {y = 5}}, {x = {y = 5},z = 55} )
assertq( fn{x = 6}:patch( 3 ), {x = 6} )
assertq( fn.patch( 'ddd', {x = 4}), 'ddd' )
assertq( fn.patch( 'ddd', 555 ), 'ddd' )
assertq( fn{x = {y = 6, z = {55}, u = 69}}:patch{x = {z = {n = 5}}}, {x = {y = 6, z = {55, n = 5}, u = 69}} )
