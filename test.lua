...
assertq( fn{}:merge( {1,2,3,4}, fn.lt ), {1,2,3,4} )
assertq( fn{1,2,3,4}:merge( {}, fn.lt ), {1,2,3,4} )
assertq( fn{6,7,8}:merge( {1,2,3,4,5}, fn.lt ), {1,2,3,4,5,6,7,8} )
assertq( fn{1,3,4,6,8}:merge( {2,5,7}, fn.lt ), {1,2,3,4,5,6,7,8} )
