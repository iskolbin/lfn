...
assertq( fn{1,2,3,4,5,6,7,8}:slice( 5 ), {5,6,7,8} )
assertq( fn{1,2,3,4,5,6,7,8}:slice( -2 ), {7,8} )
assertq( fn{1,2,3,4,5,6,7,8}:slice( 1, 1 ), {1} )
assertq( fn{1,2,3,4,5,6,7,8}:slice( 3, 5 ), {3,4,5} )
assertq( fn{1,2,3,4,5,6,7,8}:slice( 5, -2), {5,6,7} )
print('shuffling:', fn(10):shuffle():tostring())
assertq( fn{1,2,3,4}:reverse(), {4,3,2,1} )
assertq( fn{1,2,3,4}:append{5,6}, {1,2,3,4,5,6} )
assertq( fn{5,6}:append{5,5}, {5,6,5,5} )
